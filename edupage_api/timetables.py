...
class EduOnlineLesson(EduLesson):
    def __init__(self, name, subject_id, teacher, classroom, length, online_lesson_link):
    ...
    def sign_into_class(self, edupage):
        ...
        gse_hash = response.content.decode().split("gsechash=")[1].split('"')[1] # I have no idea what this is, but it can be easily parsed
